...
#Recaptcha
RECAPTCHA_PUBLIC_KEY = ENVIRONMENT.get('RECAPTCHA_PUBLIC_KEY', '6Lesq-ISAAAAAJyki1lOgqvVwXccDZ-JcjNW6mPg')
RECAPTCHA_PRIVATE_KEY = ENVIRONMENT.get('RECAPTCHA_PRIVATE_KEY', '6Lesq-ISAAAAAGIhmxDgR_dcwJKFlcYRNKcoi2Wx')
